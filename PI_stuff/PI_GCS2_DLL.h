...
BOOL PI_FUNC_DECL PI_qKLC (int ID, const char* szNameOfCoordSystem, const char* szNameOfCoordSystem2, const char* szItem1, const char* szItem2, char* buffer, int bufsize);

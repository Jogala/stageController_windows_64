...
void stageController::initialize(){
    ...
    cout<<"void stageController::initialize()"<<endl;
...
bool stageController::establishConnection(){
    ...
    cout<<"bool stageController::establishConnection()"<<endl;
...
void stageController::closeConnection(){
    ...
    cout<<"void stageController::closeConnection()"<<endl;
...
void stageController::printNameOfConnectedAxis(){
    ...
    cout<<"void stageController::printNameOfConnectedAxis()"<<endl;
...
bool stageController::switchChannelsOn(){
    ...
    cout<<"bool stageController::switchChannelsOn()"<<endl;
...
void stageController::setFocus_and_writeValuesToFile(double focus[3]){
    ...
    cout<<"void stageController::setFocus_and_writeValuesToFile(double xFocus, double yFocus, double zFocus) ENTERING"<<endl;

    for(int i=0;i<3;i++)
    {
        itsFocusValues[i]=focus[i];
    }
    cout<<"new focus values assinged to stageController Object"<<endl;

    fstream f;
    f << fixed;
    f << setprecision(5);

    cout<<"Trying to write new focus values to file "<<fileName_FocusValues<<endl;
    ...
    if(!(f.is_open()))
    {
        ...
        cout<<"failed to open "<< fileName_FocusValues <<endl;
    }
    else
    {
        cout << fileName_FocusValues <<" opened successfully "<<endl;

        for(int i=0;i<3;i++)
        {
            f<<itsFocusValues[i]<<endl;
        }

        f.close();
        cout << fileName_FocusValues <<" closed "<<endl;
    }

    focusValuesWereSet=true;

    cout<<"void stageController::setFocus_and_writeValuesToFile(double xFocus, double yFocus, double zFocus) LEAVING"<<endl;
}
void stageController::loadFocusValuesFromFile(){
    ...
    {
        cout<<f.is_open()<<endl;
        cout<<"trying to open"<< fileName_FocusValues << " failed" <<endl;
    }else
    {
        cout<< fileName_FocusValues << " opened " <<endl;
...
void stageController::getFocusValues(double focus[3]){
    ...
    if(focusValuesWereSet)
    {
        ...
        cout<<"YOU ARE TRYING TO GET FOCUS VALUES BUT THEY HAVE NOT BEEN LOADED YET"<<endl;
        cout<<"CALL loadFocusValuesFromFile BEFORE USING getFocusValues"<<endl;
        cout<<"HENCE THE DEFAULT VALUES WHICH ARE SET IN THE CONSTRUCTOR 0 0 0 ARE USED"<<endl;
    }
}
...
void stageController::moveInFocus(){
    ...
    cout<<"void stageController::moveInFocus()"<<endl;
...
bool stageController::switchAllServosOn(){
    ...
    cout<<"bool stageController::switchAllServosOn()"<<endl;
...
void stageController::moveTo(double xCoord, double yCoord, double zCoord){
    ...
    cout<<"void stageController::moveTo(double xCoord, double yCoord, double zCoord)"<<endl;
...
void stageController::moveTo(const double coord[3]){
    ...
    cout<<"void stageController::moveTo(const double coord[3])"<<endl;
...
void stageController::move(double xDelta, double yDelta, double zDelta){
    ...
    cout<<"void stageController::move(double xDelta, double yDelta, double zDelta)"<<endl;
...
void stageController::waitUntilMoveFinished(){
    ...
    cout<<"void stageController::waitUntilMoveFinished()"<<endl;
...
void stageController::printPosition(){
    ...
    cout<<"void stageController::printPosition()"<<endl;
...
bool stageController::switchVelocityControlModeOn(){
    ...
    cout<<"bool stageController::switchVelocityControlModeOn()"<<endl;
...
bool stageController::switchDriftControlModeOn(){
    ...
    cout<<"bool stageController::switchDriftControlModeOn()"<<endl;
...
void stageController::setVelocity(double xVelocity, double yVelocity, double zVelocity){
    ...
    cout<<"void stageController::setVelocity(double xVelocity, double yVelocity, double zVelocity)"<<endl;
...
void stageController::deltaVelocity(double xDeltaVelocity, double yDeltaVelocity, double zDeltaVelocity){
    ...
    cout<<"void stageController::deltaVelocity(double xDeltaVelocity, double yDeltaVelocity, double zDeltaVelocity)"<<endl;
...
void stageController::printVelocity(){
    ...
    cout<<"void stageController::printVelocity()"<<endl;
...
void stageController::setLimits(int whichAxis, double value1, double value2){
    ...
    cout<<"void stageController::setLimits(int whichAxis, double value1, double value2)"<<endl;
...
void stageController::setLimitsMin(int whichAxis, double min){
    ...
    cout<<"void stageController::setLimitsMin(int whichAxis, double min)"<<endl;
...
void stageController::setLimitsMax(int whichAxis, double max){
    ...
    cout<<"void stageController::setLimitsMax(int whichAxis, double max)"<<endl;
...
void stageController::setTriggerMode(int whichAxis, int mode){
    ...
    cout<<"void stageController::setTriggerMode(int whichAxis, int mode)"<<endl;
...
void stageController::openShutter(){
    ...
    cout<<"void stageController::openShutter()"<<endl;
...
void stageController::closeShutter(){
    ...
    cout<<"void stageController::closeShutter()"<<endl;
    ...
    cout<<"LEAVING void stageController::closeShutter()"<<endl;
}
...
bool stageController::checkIfAnyLimit(){
    ...
    cout<<"bool stageController::checkIfAnyLimit()"<<endl;
...
void stageController::sendMacros(string nameOfFile){
    ...
    cout<<"void stageController::sendMacros(string nameOfFile)"<<endl;
...
void stageController::startMacro(string nameOfmacro){
    ...
    cout<<"void stageController::startMacro(string nameOfmacro)"<<endl;
...
void stageController::startMacroAndWaitWhileRunning(string nameOfmacro){
    ...
    cout<<"void stageController::startMacroAndWaitWhileRunning(string nameOfmacro)"<<endl;
...
string stageController::setLimitsMacro(int whichAxis, double value1, double value2, double altValue1, double altValue2){
    ...
    cout<<"string stageController::setLimitsMacro(int whichAxis, double value1, double value2, double altValue1, double altValue2)"<<endl;
...
{
    cout<<"stageController::stageController()"<<endl;
    ...
    cout<<"stageController::stageController() LEAVING"<<endl;
}
stageController::~stageController()
{
